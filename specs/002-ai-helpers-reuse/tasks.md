...
- [X] T002 [SETUP] Initialize `package.json` with name `clai`, bin entry `helpers`, ESM type, Node 20+ engines, and install dependencies: `giget`, `c12`, `citty`, `consola`, `pathe`, `defu`; devDependencies: `vitest`, `typescript`, `@types/node`
